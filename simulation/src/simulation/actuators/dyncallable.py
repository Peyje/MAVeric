...
class Dyncallable(morse.core.actuator.Actuator):
    """
    ...
    """
    _name = "Dyncallable"
    _short_desc = "Same as the dynamic controller for quadrotors but with a function to set the engine speeds over the socket"
    ...
    @service
    def setspeed(self,one,two,three,four):
        self.local_data['engines'] = [one, two, three, four]
